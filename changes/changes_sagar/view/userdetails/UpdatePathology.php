                            ...
                            <div class="w3-content w3-display-container">
                                <div class="mySlides" id="slide1">
                                    ...
                                    <div class="textdetails">
                                        ...
                                        <div class="clearfix">&nbsp;</div>
                                        <h4 class="title-details" style="padding-left: 15px;">Pathology Establishment  </h4>
                                        <div class="col-md-4">
...
//                                                }
                                        ...
                                        <div class="textdetails">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                echo $form->numberField($model, 'mobile', array('maxlength' => 10, "class" => "w3-input input-group mobileclass ", "data-msg-required" => "Please Enter Mobile", "data-rule-required" => "true", "data-rule-regexp" => "^[\d]+$", "onblur" => "chk_mobile()","disabled"=>"true" ));
                                                ?>
...
?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4"> 
                                            <span>Per Day</span>
<?php
echo $form->textField($model, 'free_opd_perday', array("class" => "w3-input input-group"));
...
?>
                                            ...
                                            <select multiple="multiple"  class="form-control2 multipleselect3" name="UserDetails[free_opd_preferdays][]" style="width:80%;">
                                            <?php
