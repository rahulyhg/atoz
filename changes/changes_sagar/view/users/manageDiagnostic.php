...
<div class="tab-content"><!-- tab-content start-->
        ...
        //"role"=>Yii::app()->getSecurityManager()->encrypt(7,"' . $enc_key . '")),array("style" => "color: white;", 'class' => 'btn'));
            ...
            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>Inactive Diagnostic', array('users/manageInactiveDiagnostic'),array("style" => "color: white;", 'class' => 'btn btn-info'));
            ?>
                   </div><!--link End-->   
                                ...
                                array(
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("users/viewAllLab",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '"), "role" => 7))',
                                            'imageUrl' => false,
