    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('diagnostic', 'updateDiagnostic', 'manageDiagnostic', 'viewDiagnostic', 'bloodBank', 'getSubSpeciality', 'updateAdminBloodBank', 'updateBloodBank', 'manageBloodBank', 'createAdminBloodBank', 'viewBloodBank', 'updateHospitalServices', 'viewServices', 'ambulanceDetails', 'manageAmbulanceServices', 'addAdminEmergencyServices', 'updateAdminEmergencyServices', 'viewEmergencyServices', 'getOpdtrnsferDoctor', 'transferOpd', 'manageInactiveDiagnostic', 'manageInactiveBloodBank', 'manageInactiveAmbulanceServices', 'editReport', 'manageHospitalServices', 'addHospitalServices', 'deleteRec', 'getDocument'),
                'users' => array('*'),
            ),
