...
class NotificationController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'admin', 'confirmNotification'),
                'users' => array('*'),
            ),
    ...
    public function actionConfirmNotification() {
        ...
        $session->open();
        $usetid = $session['user_id'];
        Yii::app()->db->createCommand()->update('az_notification', array('viewed' => '1'), 'user_id =:id', array(':id' => $usetid));
    }
