...
<div class="tab-content"><!-- tab-content start-->
        <section class="content"> <!-- section content start -->
            ...
            <?php echo CHtml::link('<i class = "fa  fa-gear  fa-fw"></i> View Country ', array('countryMaster/view', 'id' => Yii::app()->getSecurityManager()->encrypt($model->country_id, $enc_key)), array("style" => "color: white;", 'class' => 'btn btn-info')); ?>
