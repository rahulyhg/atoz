...
<div class="form ">
    ...
    <div class="container">
        ...
        <section id="intro">
            ...
            <h4 class='text-center' style='padding: 30px;'>UPDATE AMBULANCE</h4>
            <div class="form-grop">

                <div class="col-sm-3">
                    <label><span>Owner Name</span></label>
                ...
                <div class="col-sm-3">
                    <label><span>Type of Ambulance</span></label>
                    <?php
                ...
                <div class="col-sm-3">
                    <label><span>Registration no.</span></label>
            ...
            <div class="form-grop clearfix">
                ...
                <div class="col-sm-3">
                    <label><span>Driver Name</span> </label>
                ...
                <div class="col-md-3">
                    <label><span>Smart Phone</span> </label>
            ...
            <div class="form-grop clearfix">
                ...
                <div class="col-sm-4">
                    <label><span>24x7 Emergency  </span></label>
                ...
                <div class="col-sm-4">
                    <label><span>Free Services  </span></label>
            ...
            <div class="form-grop clearfix">
                ...
                <div class="col-md-4">
                     <label><span>Vehicle No</span></label>
                    <?php
                ...
                <div class="col-md-4">
                     <label><span>Vehicle Type</span></label>
                    <?php
            ...
            <div class="clearfix">&nbsp;</div>
             <div class="form-grop clearfix">
                <div class="col-sm-4">
                     <label><span>Executive Name</span> </label>
                    <?php
                ...
                <div class="col-sm-4">
                     <label><span> Executive Contact no.</span></label>
                    <?php
                ...
                <div class="col-sm-4">
                     <label><span> Documents upload</span></label>
                    <?php
            ...
            <div class="form-grop clearfix">
                <div class="col-sm-4">
                    <label><span>Sr./Surve/Bldg No.</span></label>
                    <?php
            ...
            <div class="clearfix"></div>
<!--            <div class="form-group clearfix">
                <input type="checkbox" name="acceptcondition"  class="agree required"/> I/ we Agree with the term and condition mentioned in the web policy of the company and attached annexure.
