...
<section class="content-header">
    ...
    <h3>Manage Ambulance Services</h3>
</section>
                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                           ...
                           <?php echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Ambulance', array('users/addAdminEmergencyServices',"roleid"=>10), array("style" => "color: white;", 'class' => 'btn btn-info'));
                           ?>
                               <?php echo CHtml::link('<i class = "fa  fa-plus  fa-fw"></i> Inactive Ambulance ', array('Users/manageInactiveAmbulanceServices',"roleid"=>10), array("style" => "color: white;", 'class' => 'btn btn-info')); ?>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $model->searchambulance($roleid),
        ...
        array(
            ...
            array(
                ...
                array(
                    ...
                    'url' => 'Yii::app()->createUrl("users/updateAdminEmergencyServices",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '"), "roleid" => '.$roleid.'))',
                    'imageUrl' => false,
                ...
                array(
                    ...
                    'url' => 'Yii::app()->createUrl("users/viewEmergencyServices",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '"), "roleid" => '.$roleid.'))',
                    'imageUrl' => false,
