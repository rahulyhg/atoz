...
<?php if($roleid == 8) {
                            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Blood-Bank', array('users/createAdminBloodBank',"role"=>8), array("style" => "color: white;", 'class' => 'btn btn-info'));?>
                              ...
                              <?php echo CHtml::link('<i class = "fa  fa-plus  fa-fw"></i>Active Blood-Bank', array('Users/manageBloodBank','roleid'=>8), array("style" => "color: white;", 'class' => 'btn btn-info')); 
               }  ?>
                            ...
                            <?php if($roleid == 9) {
                                ...
                                <?php echo CHtml::link('<i class = "fa  fa-plus  fa-fw"></i>Active Medical-Store', array('Users/manageBloodBank','roleid'=>9), array("style" => "color: white;", 'class' => 'btn btn-info')); 
                            }?>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $model->searchinactivebloodbank($roleid),
        ...
        array(
            ...
            array(
                ...
                array(
                    ...
                    'url' => 'Yii::app()->createUrl("users/viewBloodbank",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '"), "role" => '.$roleid.'))',
                    'imageUrl' => false,
