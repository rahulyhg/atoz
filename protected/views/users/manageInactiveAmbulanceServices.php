                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                           ...
                           ?>
                                <?php echo CHtml::link('<i class = "fa  fa-plus  fa-fw"></i> Active Ambulance ', array('Users/manageAmbulanceServices',"roleid"=>10), array("style" => "color: white;", 'class' => 'btn btn-info')); ?> 
               </div><!--link End-->    
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $model->searchInactiveambulance($roleid),
