                ...
                <div class="col-lg-12"> <!-- column col-lg-12 start -->
                    ...
                    ?>
                            ...
                            <div class="text-right"><!--link div-->
                                  <?php
        //"role"=>Yii::app()->getSecurityManager()->encrypt(7,"' . $enc_key . '")),array("style" => "color: white;", 'class' => 'btn'));
            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Diagnostic', array('userDetails/createAdminPathology',"role"=>7),array("style" => "color: white;", 'class' => 'btn btn-info'));
            ?>
                                  <?php
       
            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>Active Diagnostic', array('users/manageDiagnostic'),array("style" => "color: white;", 'class' => 'btn btn-info'));
            ?>
                   </div><!--link End-->   
                ...
                <?php endif; ?>
                      <div class="table-responsive">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'dataProvider' => $model->searcInhospial(),
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'header' => 'Type Of Diagnostic',
                                    'value' => '$data->type_of_hospital ',
                                ),
                               array(
                                    'header' => 'Diagnostic Registration No',
                                ...
                                array(
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("userDetails/updateAdminPathology",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '"),"role" => 7))',
                                            'imageUrl' => false,
                                        ...
                                        array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("users/viewDiagnostic",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '")))',
                                            'imageUrl' => false,
