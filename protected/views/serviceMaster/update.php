                    ...
                    <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                        <div class="box-header with-border"><!-- box header start -->
                            <div class="text-right"><!--link div-->
                                          <?php echo CHtml::link('<i class = "fa  fa-gear  fa-fw"></i> View Service ', array('serviceMaster/view', 'id' => Yii::app()->getSecurityManager()->encrypt($model->service_id, $enc_key)), array("style" => "color: white;", 'class' => 'btn btn-info')); ?>
