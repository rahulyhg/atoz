...
$('.search-form form').submit(function(){
	$('#speciality-master-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
Yii::app()->clientScript->registerScript('search1', "
 function testFun(speciality_id, htmlObj) {
    var is_active;
    ...
    $.ajax({
          url:'" . Yii::app()->createUrl('SpecialityMaster/ActiveStatus') . "', 
          type : 'POST', 
          data : {is_active:is_active,speciality_id:speciality_id},
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'columns' => array(
                                    ...
                                    array(
                                        'name' => 'img_name',
                                        'type' => 'raw',
                                        'value' => 'CHtml::image(Yii::app()->baseUrl ."/uploads/".$data->img_name,"",array("style"=>"width:125px;height:125px;"))'
                                    ),
                                    array(
                                        'name' => 'is_active',
                                        'type' => 'raw',
                                        'value' => '$data->ActiveStatus($data->is_active, $data->speciality_id)',
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("SpecialityMaster/update",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->speciality_id,"' . $enc_key . '")))',
                                                'imageUrl' => false,
                                            ...
                                            array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("SpecialityMaster/view",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->speciality_id,"' . $enc_key . '")))',
                                                'imageUrl' => false,
