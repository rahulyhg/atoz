                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                            ...
                            ?>
                            <?php
                            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>Active Pathology', array('userDetails/managePathology', "role" => 6), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                        </div><!--link End-->   
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("userDetails/viewPathology",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '")))',
                                                'imageUrl' => false,
