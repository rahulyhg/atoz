                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                            ...
                            <?php
                            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Patient', array('userDetails/createAdminPatient'), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                            <?php
                            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Active Patient', array('userDetails/adminpatient'), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                        </div><!--link End-->    
                        ...
                        <div class="table-responsive">
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider' => $model->searchInactivePatient($model->role_id),
