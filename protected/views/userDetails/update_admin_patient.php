                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        <div class="text-right"><!--link div-->
                            ...
                            <?php if($model->patient_type != 'Corporate'){
                             echo CHtml::link('<i class = "fa fa-gear fa-fw"></i> Manage Patients', array('userDetails/adminpatient'), array("style" => "color: white;", 'class' => 'btn btn-info')); }
                             else{
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput" style="position: relative;">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="background: transparent;width:140px;height:140px;text-align: center; margin: auto;border-radius: 50%;overflow: hidden;">
                                        ...
                                        if (empty($model->profile_image)) {
                                                       ...
                                                       echo CHtml::image(Yii::app()->request->baseUrl . "/images/icons/icon01.png", "Patient Photo", array("class" => "img-circle", "width" => "150"));
...
?>
                            ...
                            <div class="col-sm-8 patient_type clearfix">
                                <div class="loginheadingmargin">
                                    ...
                                    <?php
                                    echo $form->radioButtonList($model, 'patient_type', array('Individual' => 'Individual',  'Corporate' => 'Corporate'), array('class' => 'selectuser', 'labelOptions' => array('style' => 'display:inline'), 'separator' => '&nbsp;&nbsp;&nbsp;', 'template' => '<label class="ui-radio-inline">{input} <span>{label}</span></label>', 'container' => 'div class="ui-radio ui-radio-pink"'));
                                    ?>

                                </div>
                            </div><div  class="clearfix"></div>
                        </div>
                        <div class="form-group company_name clearfix" style=" <?php echo $model->patient_type == "Corporate" ? "" : 'display: none;'; ?>">
<!--                            <label class="col-md-2 nopadding">Company Name</label>
                            <div class="col-md-4 nopadding">
                                <?php
                              //  echo $form->textField($model, 'company_name', array('maxlength' => 100, "class" => "form-control company_name1", "placeholder" => "Company Name"));
                                ?>
                                <span id="company_name" class="error1"></span>
                            </div>-->

                            <div class="clearfix"></div>
                        </div>
                        <div  class="clearfix"></div>
                        <div class="form-group clearfix role" style=" <?php echo $model->patient_type == "Premium member" ? "" : 'display: none;'; ?>">
                            
                            <div class="col-md-4" style="">
                                <label class="nopadding">VVIP</label>
                                <?php
                                echo $form->textField($model, 'vip_role', array('maxlength' => 100, "class" => "form-control col-sm-6 role1", "placeholder" => "VVIP"));
                                ?>
                                <span id="role" class="error1" ></span>
                            </div>
                            <div class="clearfix"></div>
                        </div> 
                        <div  class="clearfix"></div>
                        <div class="form-group fullname">
                            ...
                            <div class="col-md-4 nopadding">
                                <?php
                                echo $form->textField($model, 'first_name', array('maxlength' => 100, "class" => "form-control firstname1", "placeholder" => "First Name"));
                                ?>
                                <span id="firstname" class="error1"></span>
                            </div>
                            <div class="col-md-4" style="padding-right: 0;">
                                <?php
                                echo $form->textField($model, 'last_name', array('maxlength' => 100, "class" => "form-control col-sm-6 lastname1", "placeholder" => "Last Name"));
                                ?>
                                <span id="lastname" class="error1"></span>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="form-group">                                                    	
                            ...
                            <div class="col-md-4" style="">
                                ...
                                <?php echo $form->dropDownList($model, 'blood_group', array('O+' => 'O+', 'O-' => 'O-', 'A+' => 'A+', 'A-' => 'A-', 'B+' => 'B+', 'B-' => 'B-', 'AB+' => 'AB+', 'AB-' => 'AB-'), array('class' => 'otherselect form-control input-group', "data-rule-required" => "true", 'prompt' => 'Select Blood Group', "data-msg-required" => "Please select Blood Group")); ?>
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-4 ">
                                ...
                                <?php echo $form->numberField($model, 'mobile', array('maxlength' => 10, "class" => "form-control", "data-rule-required" => "true", "data-msg-required" => "Please Enter mobile", "data-rule-regexp" => "^[\d]+$")); ?>
                            </div>
                            <div class="col-md-4 ">
                                <?php echo $form->labelEx($model, 'Password'); ?> 
                                <?php
                                $model->password = "";
                                echo $form->passwordfield($model, 'password', array('maxlength' => 10, "class" => "form-control"));
                                ?>
                            </div>
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-4 contacts">
                               <?php echo $form->labelEx($model, 'Contact Number'); ?> 
                                <?php
                                echo $form->numberField($model, 'apt_contact_no_1', array("data-rule-regexp" => "^[7-9]{1}[0-9]{9,29}$", "class" => "form-control", "data-rule-required" => "true", "data-msg-required" => "Please Enter contact no"));
                                ...
                                <div class="contact_no_2 "hidden="">
                                    <?php
                                    echo $form->numberField($model, 'apt_contact_no_2', array("class" => "form-control", "data-rule-required" => "true", "data-msg-required" => "Please Enter contact no", "data-rule-regexp" => "^[7-9]{1}[0-9]{9,29}$"));
