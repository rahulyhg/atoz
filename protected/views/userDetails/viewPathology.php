...
<div class="tab-content"><!-- tab-content start-->
        <section class="content"> <!-- section content start -->
            <div class="row"><!-- row start-->
                ...
                <tbody>
                    <tr class="odd"><th>Pathology Name</th><td><?php echo CHtml::encode($model->hospital_name); ?></td></tr>
                    <tr class="odd"><th>Type of Pathology</th><td><?php echo CHtml::encode($model->type_of_hospital); ?></td></tr>
                    <tr class="odd"><th>Pathology Registration No</th><td><?php echo CHtml::encode($model->hospital_registration_no); ?></td></tr>
                    <tr class="odd"><th>Pathology Establishment</th><td><?php echo CHtml::encode($model->hos_establishment); ?></td></tr>
