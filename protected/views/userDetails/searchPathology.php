...
<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="form-grop">
            <?php echo $form->label($model, 'Pathology Name', array("class" => "col-sm-2 control-label")); ?>
            <div class="col-sm-4">
        ...
        <div class="form-grop">
            ...
            <div class="col-sm-4">
                <?php echo $form->textField($model, 'hospital_registration_no', array('maxlength' => 100, 'class' => 'form-control')); ?>
            </div>
