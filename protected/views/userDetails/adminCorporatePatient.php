...
?>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/admin/jquery.ba-bbq.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/admin/jquery.yiigridview.js"></script>
<?php
                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                            ...
                            <?php
                            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Corporate', array('userDetails/createAdminCorporate'), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                            <?php
                            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>Inactive Corporate', array('userDetails/manageInactivePatient'), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                        </div><!--link End-->    
                        ...
                        <div class="table-responsive">
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider' => $model->searchCororate($model->role_id),
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("UserDetails/updateAdminCorporate",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '")))',
                                                'imageUrl' => false,
