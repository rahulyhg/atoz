...
$(".datepick").datepicker({
 ...
 function showNextSlide(nextslideid, tabid){
        ...
        if($("#pathology-form").valid()){
       // if(1){
            $.ajax({
                type: "POST",
                url: "' . $setDataLink . '",
                data: $("#pathology-form").serialize(),
                //dataType: "json",
        ...
        <div class="container">
            <div class="main-text">
                ...
                $form = $this->beginWidget('CActiveForm', array(
                    'id' => 'pathology-form',
                    'action' => array('userDetails/pathologySetData'),
                ...
                <div class="row">
                    <div class="col-md-3" style="background-image:url(<?= $baseUrl; ?>/images/icon46.png);height: 1105px;background-size: 100% auto;background-position: center center;">
                        <div class="fileinput fileinput-new" data-provides="fileinput" style="position: relative;">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="background: transparent;width:140px;height:140px;text-align: center; margin: auto;border-radius: 50%;overflow: hidden;">
                                ...
                                if (empty($model->profile_image)) {
                                    echo CHtml::image(Yii::app()->request->baseUrl . "/images/icons/pathology.png", "Profile Photo", array("class" => "img-circle", "width" => "150"));
                                }
                                ?>
                        ...
                        <ul class="nav nav-pills nav-stacked "  id="myTabs">
                            <li class="active"><a href="#tab_a" data-toggle="pill">Pathology Details &nbsp; <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                </a></li>
                        ...
                        <div class="tab-pane active" id="tab_a">                                         
                            <div class="w3-content w3-display-container">
                                <div class="mySlides" id="slide1">
                                    ...
                                    <h4 class="title-details" style="padding-left: 15px;">Pathology Details  </h4>
                                    <div class="textdetails">
                                        ...
                                        <div class="textdetails">
                                            <div class="col-md-4">
                                                <span style="padding-left:15px">Types Of Lab Center</span>
                                                <?php
                                        ...
                                        <div class="textdetails">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                echo $form->textField($model, 'mobile', array('maxlength' => 10, "class" => "w3-input input-group mobileclass ", "data-msg-required" => "Please Enter Mobile", "data-rule-required" => "true", "data-rule-regexp" => "^[\d]+$", "onblur" => "chk_mobile(this)"));
                                                ?>
...
//                                                }
                                        ...
                                        <div class="textdetails">
                                            ...
                                            <div class="col-md-5 contacts">
                                                ...
                                                echo $form->textField($model, 'apt_contact_no_1', array("data-rule-regexp" => "^[7-9]{1}[0-9]{9,29}$", "class" => "w3-input input-group"));
                                                ...
                                                <div class="textdetails contact2" style="display: none;">
                                                    ...
                                                    echo $form->textField($model, 'apt_contact_no_2', array("data-rule-regexp" => "^[7-9]{1}[0-9]{9,29}$", "class" => "w3-input input-group"));
                                        ...
                                        <div class="textdetails">
                                            ...
                                            <div class="col-md-4">                                                    	
                                                ...
                                                echo $form->textField($model, 'coordinator_mobile_2', array('maxlength' => 10, "class" => "w3-input input-group", "data-rule-regexp" => "^[\d]+$"));
                                        ...
                                        <div class="textdetails">
                                            <div class="col-md-4">
                                                <span>Zip Code<strong class="mandatory">*</strong></span>
                                                <?php
                                            ...
                                            <div class="col-md-4">
                                                <span>City<strong class="mandatory">*</strong></span>
                                                <?php
                                                $cityArr = array();
                                        ...
                                        <div class="textdetails">
                                            ...
                                            <div class="col-md-4">
                                                <span>Landmark<strong class="mandatory">*</strong></span>
                                                <?php
                                            ...
                                            <div class="col-md-4">
                                                <span>Address<strong class="mandatory">*</strong></span>
                                                <?php
                                ...
                                <div class="mySlides"  id="slide2">
                                    ...
                                    <div class="textdetails">
                                        <div class="col-md-3">
                                            ...
                                            $serviceArr = array();
                                            $selected = array();
                                            $serviceType = Yii::app()->db->createCommand()->select("service_id,service_name")->from("az_service_master")->where('role_id=6')->queryAll();
                                    ...
                                    <div class="textdetails clearfix freeCharge" style="display:none">
                                        <div class="col-md-3 freeSelection">
                                            ...
                                            <?php echo $form->dropDownList($model, 'blood_bank_no', array("Free" => "Free", "Charge" => "Charge"), array("class" => "w3-input input-group"));
                                            ?>
                                        </div>

                                        <div class="col-md-3 chargeSelection" style="display:none"> 
                                            <span>Charge</span>
                                            <?php echo $form->textField($model, 'extra_charges', array("class" => "w3-input input-group", "data-msg-required" => "Please Check Your Input", "data-rule-regexp" => "^[\d]+$", "value" => "")); ?>
                                        </div>
                                    ...
                                    <div class="textdetails clearfix">
                                        ...
                                        <div class="col-md-4"> 
                                            <span>Corporate Discount</span>
                                            <?php
                                            echo $form->textField($model, 'opd_no', array("class" => "w3-input input-group", "data-msg-required" => "Please Check Your Input", "data-rule-regexp" => "^[\d]+$"));
                                            ?>
                                        </div>
                                    ...
                                    <div class="textdetails clearfix">
                                        <br><h4 class="title-details">Free Offerings</h4>
                                        <div class="col-md-4"> 
                                            <span>Per Day</span>
                                            <?php
