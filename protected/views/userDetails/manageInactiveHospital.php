...
<!-- Page Content Start -->
    ...
    <h3>Manage  Inactive Hospital</h3>
</section>
<div class="tab-content"><!-- tab-content start-->
        <section class="content"> <!-- section content start -->
          ...
          <?php
            ...
            echo CHtml::link('<i class = "fa fa-plus fa-fw"></i>Create Hospital', array('userDetails/createAdminHospital'),array("style" => "color: white;", 'class' => 'btn btn-info'));
            ?>
               <?php
        
            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>active Hospital', array('userDetails/manageHospital'),array("style" => "color: white;", 'class' => 'btn btn-info'));
            ?>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => 'CHtml::link("Manage Doctor",array("userDetails/manageHospitalDoctor", "param1" => base64_encode($data->user_id) ))',
                                    'htmlOptions' => array("style" => "text-align:center;")
                                ),
                                array(
                                    'class' => 'CButtonColumn',
                                    ...
                                    array(
                                        ...
                                        array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("userDetails/updateAdminHospital",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '")))',
                                            'imageUrl' => false,
                                        ...
                                        array(
                                            ...
                                            'url' => 'Yii::app()->createUrl("userDetails/viewHospital",array("id"=>Yii::app()->getSecurityManager()->encrypt($data->user_id,"' . $enc_key . '")))',
                                            'imageUrl' => false,
