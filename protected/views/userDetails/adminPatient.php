                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        ...
                        <div class="text-right"><!--link div-->
                            ...
                            ?>
                            <?php
                            echo CHtml::link('<i class = "fa fa-trash fa-fw"></i>Inactive Patient', array('userDetails/manageInactivePatient'), array("style" => "color: white;", 'class' => 'btn btn-info'));
                            ?>
                        </div><!--link End-->    
                        ...
                        <div class="table-responsive">
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                ...
                                'dataProvider' => $model->search($model->role_id),
