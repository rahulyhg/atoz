                ...
                <div class="box box-warning direct-chat direct-chat-warning"> <!-- box start -->
                    <div class="box-header with-border"><!-- box header start -->
                        <div class="text-right"><!--link div-->
                            ...
                            <?php echo CHtml::link('<i class = "fa  fa-gear  fa-fw"></i> Manage Hospital ', array('site/hosViewAppointment'), array("style" => "color: white;", 'class' => 'btn btn-info')); ?>
                                ...
                                <div id="sectionA" class="tab-pane fade in active">
                                    ...
                                    <div class="box box-primary">
                                        <div class="form-group clearfix">
                                            <div class="col-sm-4">
                                                   <?php echo $form->labelEx($model, 'Profile Image');  
                                            ...
                                            <div class="col-sm-4">
                                                  <?php echo $form->labelEx($model, 'Hospital Name');  
                                            ...
                                            <div class="col-sm-4">
                                              <?php echo $form->labelEx($model, 'Type Of Hospital');  
//HOSPITAL_CATEGORY is constant which contain hospital category
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-sm-4">
                                                <?php echo $form->labelEx($model, 'Hospital Registration No');  
                                            ...
                                            <div class="col-sm-4">
                                                <?php echo $form->labelEx($model, 'Hospital Establishment');  
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php echo $form->textField($model, 'landline_1', array("class" => "form-control", "data-rule-required" => "true", "data-msg-required" => "Please Enter Landline")); ?>
                                                ...
                                                ?>>
                                                   <?php echo $form->labelEx($model, 'Landline No'); ?>
                                                    <?php echo $form->textField($model, 'landline_2', array("class" => "form-control", "data-rule-required" => "true", "data-msg-required" => "Please Enter Landline")); ?>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-sm-4">
                                                ...
                                                ?>>
                                                   <?php echo $form->labelEx($model, ' Emergency No'); ?>
                                                    <?php echo $form->textField($model, 'emergency_no_2', array('maxlength' => 101,"class" => "form-control")); ?>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-4">
                                              <?php echo $form->labelEx($model, 'Coordinator Mobile');
                                            ...
                                            <div class="col-sm-4">
                                               <?php echo $form->labelEx($model, 'Coordinator Email');
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-4 hospitaltime" <?php echo $model->is_open_allday == "N" ? "" : 'style="display:none;"'; ?>>
                                                <div class="col-md-6" >
                                                       ...
                                                       <?php echo $form->labelEx($model, 'Hospital Open Time');
                                                ...
                                                <div class="col-md-6" >
                                                     ...
                                                     <?php echo $form->labelEx($model, 'Hospital  Close Time');
                                    ...
                                    <div>
                                        ...
                                        if (count($serviceUserMapping) > 0 && is_array($serviceUserMapping)) {
                                            ...
                                            <div class=" form-group serviceclone clearfix" id="serviceclone">
                                                ...
                                                <div class="col-sm-2  clearfix">
                                                    <span class="col-sm-1 control-label">Discount</span>
                                                    <input type="text" name="service_discount[]" value=''  class='form-control'>
                                                    <?php echo $form->error($model, 'service_discount', array('class' => 'col-sm-1 control-label')); ?>
                                                </div>
                                                <div class="col-sm-2  clearfix">
                                                    <span class="col-sm-1 control-label">Corporate Discount</span>
                                ...
                                <div id="dropdown" class="tab-pane fade">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <?php echo $form->labelEx($model, 'Hospital Registration'); 
...
//echo $form->error($model, 'registraiondoc');
                                    ...
                                    <div class="col-md-4">
                                          <?php echo $form->labelEx($model, 'Other Registration'); 
