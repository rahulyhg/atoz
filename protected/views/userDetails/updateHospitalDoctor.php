    ...
    <div class="textdetails">
                                                ...
                                                <div class="col-md-8">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="DoctorExperience[work_from]" class="expyear form-control2">
                                                                <?php
                                                                for($i=0;$i<=30;$i++){
                                                        ...
                                                        <div class="col-md-4">
                                                           ...
                                                           <select name="DoctorExperience[work_to]" class="expmonth form-control2">
                                                                <?php
                                                                for($i=0;$i<=12;$i++){
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-md-4">
                                                       ...
                                                       <select name="DoctorExperience[work_from]" class="expyear form-control2"></select>
                                                  <?php    //  echo $form->error($model1, 'work_from');
                                                        ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                      
                                                        <select name="DoctorExperience[work_to]" class="expmonth form-control2"></select>
                                                        <?php
